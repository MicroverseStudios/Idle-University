...
public class BuildingController : MonoBehaviour {
    ...
    //used to tell MoveBuilding.cs whether player is placing paths or buildings
	public static bool PathMode { get; set; }
	void Start () {
        PathMode = false;
	}
	...
	void Update () {
        ...
        if (Input.touchCount == 1 && Input.GetTouch(0).phase == TouchPhase.Began && PathMode)
        {
        ...
        else if (Input.touchCount == 1 && Input.GetTouch(0).phase == TouchPhase.Moved && PathMode)
        {
